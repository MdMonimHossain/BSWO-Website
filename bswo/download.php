...
<body class="home">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="min-width: 1000px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="download.php" style="color: #990000;">Download</a>
                        </li>
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <h2 class="mb-3 font-weight-bold">Download</h2>
            ...
            ?>
                <div class="col-lg-4 mb-4">
                    <div class="card text-center">
                        <img class="card-img-top mb-2" src="images/report/<?php echo $row['image'] ?>" alt="image" style="height: 12rem; object-fit: cover; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 5px;">
                        <div class="card-body">
