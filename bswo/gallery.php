            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="min-width: 1000px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="gallery.php" style="color: #990000;">Gallery</a>
                        </li>
            ...
            ?>
                <div class="col-lg-4 mb-4">
                    <div class="card text-center">
                        <img class="card-img-top" src="images/gallery/<?php echo $row['image'] ?>" alt="image" style="height: 15rem; object-fit: cover; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 5px;">
