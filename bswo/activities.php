...
<body class="home">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="min-width: 1000px;">
                        ...
                        <li class="nav-item dropdown">
                            <a href="activities.php" style="color:#990000; text-decoration: none; display: inline-flex; margin-top: 0.2rem; margin-left: 1rem;">Activities</a>
                            <a class="nav-link dropdown-toggle ps-0" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="display: inline-flex;">
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <div class="container mt-5" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 10px;">
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="card">
                    <img src="images/IMG_0061.jpg" class="rounded" alt="...">
                </div>
            </div>
            <div class="col-lg-6 p-5">
                <h4 class="mb-3 font-weight-bold">Microfinance Activities</h4>
                <hr allign="center" style="height:6px; width:8%; background-color:#990000; margin-top: 3px; margin-bottom:20px;">
                <p class="fs-6">
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Team building program with poor
                    people
                    <br>
                    <br>
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Helping the poor to build their own
                    capital
                    <br>
                    <br>
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Income-enhancing lending program
                    <br>
                    <br>
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Health care
                    <br>
                </p>
                <br>
                <a href="microfinance.php" class="btn btn-success">Click to know more</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 10px;">
        <div class="row">
            <div class="col-lg-6 p-5">
                <h4 class="mb-3 font-weight-bold">Other Activities</h4>
                <hr allign="center" style="height:6px; width:8%; background-color:#990000; margin-top: 3px; margin-bottom:20px;">
                <p class="fs-6">
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Birth registration, marriage
                    registration, dowry, prevention of child marriage, prevention of violence against women
                    <br>
                    <br>
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; B, C, C Program (Children,
                    Adolescents, Women, Health)
                    <br>
                    <br>
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Human Rights, Women's Empowerment,
                    Gender Issues, Day Celebrations
                    <br>
                    <br>
            ...
            <div class="col-lg-6 p-0">
                <div class="card">
                    <img src="images/BonofulTika.jpg" class="rounded" alt="...">
                </div>
            </div>
        </div>
    </div>
