...
<body class="home">
            ...
            <div class="col-md-4 mt-2">
                <div class="container p-4 text-center" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius:
                    ...
                    <p style="color: #4f4f4f; font-weight: 500;">
                        1st Floor, RFH Hosneara, Mohammadpur Chittagong - 4212, Bangladesh
                    </p>
                </div>
            </div>
    ...
    <div class="container" style="margin-top: 6rem;">
        <div class="row">
            <div class="col-lg-8 mb-2">
                <iframe style="width: 100%; height: 100%;" src="https://maps.google.com/maps?q=Banaful%20Social%20Welfare%20Organization%201st%20Floor%20RF-Hosneara%2C%20Abdul%20Karim%20Rd%2C%20Chittagong&amp;t=m&amp;z=15&amp;output=embed&amp;iwloc=near" aria-label="Banaful Social Welfare Organization 1st Floor RF-Hosneara, Abdul Karim Rd, Chittagong"></iframe>
            </div>
            <div class="col-lg-4 mb-2">
                <img class="img-fluid" src="images/office.png">
            </div>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 6rem;">
        ...
        <form class="row g-3 mt-1 p-3 fs-5">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary" style="width: 150px; font-weight: bold; font-size: 20px;">Send</button>
            </div>
        </form>
    </div>
