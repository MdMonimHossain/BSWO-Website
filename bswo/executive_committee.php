                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="min-width: 1000px;">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="executive_committee.php" style="color: #990000;">Executive Committee</a></li>
                    ...
                    15px;">
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-8 text-start ps-5">
                                ...
                                <p style="color: #0da026; font-weight: bold;">Address&nbsp;&nbsp;&nbsp;<span style="color: #7A7A87; font-weight: 600;"><?php echo $row['EC_ADDRESS'] ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
