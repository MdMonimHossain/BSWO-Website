                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="min-width: 1000px;">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="general_committee.php" style="color: #990000;">General Committee</a></li>
                                <li><a class="dropdown-item" href="staff.php">Officers and
                                        staff</a></li>
                            </ul>
                        </li>
                    ...
                    15px;">
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-8 text-start ps-5">
                                ...
                                <hr allign="center" style="height:3px; width:15%; background-color:#990000; margin-top: 4px; margin-bottom:20px;">
                                <p style="color: #0da026; font-weight: bold;">Occupation&nbsp;&nbsp;&nbsp;<span style="color: #7A7A87; font-weight: 600;"><?php echo $row['GC_OCCUP'] ?></span></p>
                                ...
                                <p style="color: #0da026; font-weight: bold;">Address&nbsp;&nbsp;&nbsp;<span style="color: #7A7A87; font-weight: 600;"><?php echo $row['GC_ADDRESS'] ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
