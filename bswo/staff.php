...
<body class="home">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="min-width: 1000px;">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="staff.php" style="color: #990000;">Officers and
                                        staff</a></li>
                            </ul>
                        </li>
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <h2 class="mb-3 font-weight-bold">Officers and Staff</h2>
            ...
            ?>
                <div class="col-lg-4 mb-4">
                    ...
                    5px;">
                        <div class="row mb-3">
                            <div class="col-6">
                                <img src="images/employee/<?php echo $row['E_IMAGE'] ?>" alt="image" class="img-thumbnail" style="width: 150px; height: 150px;">
                            </div>
                            <div class="col-6">
                                <br>
                                <br>
